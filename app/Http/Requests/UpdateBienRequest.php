...
class UpdateBienRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('editar bienes');
    }

    /**
     * Reglas de validación para actualizar un bien.
     *
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'numero_bien' => ['required', 'string', 'max:255', Rule::unique('bienes', 'numero_bien')->ignore($bien->id)],
