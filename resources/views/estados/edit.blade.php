<x-app-layout>
    ...
    <div class="py-12 relative overflow-hidden">
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('estados.update', $estado) }}" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white dark:bg-dark-850/40 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-white/5 relative group transition-all duration-500">
                    ...
                    <div class="flex items-center gap-3 mb-8">
                        ...
                        <h3 class="text-xl font-black text-gray-900 dark:text-white uppercase tracking-widest">Detalles del Estado</h3>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <textarea
                                    ...
                                    placeholder="Breve descripción de lo que representa este estado...">{{ old('descripcion', $estado->descripcion) }}</textarea>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-4">
                                <input
                                    ...
                                    id="color"
                                    name="color"
                                    value="{{ old('color', $estado->color ?? '#6b7280') }}"
                                ...
                                <span class="text-xs text-brand-lila font-bold tracking-widest uppercase" x-text="$el.previousElementSibling.value">{{ old('color', $estado->color ?? '#6b7280') }}</span>
                            </div>
