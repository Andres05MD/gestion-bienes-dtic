                        ...
                        <table class="min-w-full">
                            <thead>
                                <tr class="bg-dark-800/50">
                                    ...
                                    <th scope="col" class="px-6 py-5 text-left text-xs font-bold text-dark-text uppercase tracking-widest">Color</th>
                            ...
                            <tbody class="divide-y divide-dark-800">
                                ...
                                <tr class="hover:bg-dark-800/30 transition-all duration-300">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold">
                                        <span style="{{ $estado->badgeStyles() }}" class="px-3 py-1 inline-flex text-[10px] leading-4 font-black rounded-lg shadow-sm uppercase">
                                            {{ $estado->nombre }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-dark-text">
                                        <div class="flex items-center gap-2">
                                            <div class="w-6 h-6 rounded-lg shadow-lg border border-white/10" style="background-color: {{ $estado->resolveColor() }}"></div>
                                            <span class="text-xs font-mono font-bold text-gray-400 uppercase tracking-widest">{{ $estado->resolveColor() }}</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-dark-text">
