<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm font-medium text-gray-500 dark:text-dark-text uppercase tracking-widest mt-1">Inventario de Activos</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('bienes.store') }}" class="space-y-8">
                @csrf
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        <div class="bg-white dark:bg-dark-850/40 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-white/5 relative group transition-all duration-500">
                            ...
                            <div class="flex items-center gap-3 mb-8">
                                ...
                                <h3 class="text-xl font-black text-gray-900 dark:text-white uppercase tracking-widest">Detalles del Equipo</h3>
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="relative group">
                                    <textarea 
                                        ...
                                        name="observaciones" 
                                        rows="4" 
                                        placeholder="Ingrese cualquier detalle relevante sobre el estado o procedencia del equipo..."
