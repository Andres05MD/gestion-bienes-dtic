                ...
                <div class="relative z-10">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="relative group">
                            <label class="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-white/10 rounded-3xl cursor-pointer bg-white/2 hover:bg-brand-purple/3 hover:border-brand-purple/50 transition-all duration-500">
