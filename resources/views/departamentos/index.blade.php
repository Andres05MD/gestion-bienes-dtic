                ...
                <div class="p-6">
                    @if($departamentos->isEmpty())
                        <div class="flex flex-col items-center justify-center py-12 text-center">
                            ...
                            <h3 class="text-lg font-bold text-white mb-2">No hay departamentos registrados</h3>
                            <p class="text-gray-400 text-sm max-w-sm mb-6">Comienza registrando los departamentos o servicios de la institución.</p>
                            <a href="{{ route('departamentos.create') }}" class="text-brand-lila font-bold hover:text-brand-purple transition-colors text-sm">
                                    ...
                                    @foreach ($departamentos as $departamento)
                                        <tr class="hover:bg-dark-800/30 transition-all duration-300">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-bold flex items-center gap-3">
                                                ...
                                                <a href="{{ route('departamentos.edit', $departamento) }}" class="text-amber-400 hover:text-amber-300 transition" title="Editar">
                                                ...
                                                <button type="button" 
                                                        @click="window.dispatchEvent(new CustomEvent('open-deletion-modal', { detail: { action: '{{ route('departamentos.destroy', $departamento) }}' } }))" 
