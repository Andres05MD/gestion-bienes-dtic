                        ...
                        <table class="min-w-full">
                            <thead>
                                <tr class="bg-dark-800/50">
                                    ...
                                    <th scope="col" class="px-6 py-5 text-left text-xs font-bold text-dark-text uppercase tracking-widest">Firma</th>
                                ...
                                <tr class="hover:bg-dark-800/30 transition-all duration-300">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="flex flex-col gap-4 py-2">
                                            ...
                                            <div>
                                                ...
                                                <span class="text-[10px] text-gray-400 font-bold uppercase tracking-widest block truncate max-w-[200px]" title="{{ $t->descripcion }}">{{ $t->descripcion }}</span>
                                            </div>
                                            @endforeach
                                        </div>
                                        @else
                                    ...
                                    <td class="px-6 py-4 whitespace-normal min-w-[250px]">
                                        <div class="flex items-center gap-2">
                                            <span class="text-[11px] font-bold text-gray-400 uppercase tracking-widest">{{ $primera->procedencia?->nombre ?? 'DTIC' }}</span>
                                            <x-mary-icon name="o-arrow-right" class="w-4 h-4 text-brand-lila shrink-0" />
                                            <span class="text-[11px] font-bold text-white uppercase tracking-widest">{{ $primera->destino?->nombre ?? 'DTIC' }}</span>
                                        </div>
                                    </td>
