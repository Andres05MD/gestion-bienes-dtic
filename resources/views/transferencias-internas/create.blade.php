<x-app-layout>
    ...
    <div class="py-12 relative">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form id="transferenciaForm" method="POST" action="{{ route('transferencias-internas.store') }}" class="space-y-8" x-data="{
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="bg-white dark:bg-dark-850/40 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-white/5 relative group transition-all duration-500 hover:shadow-brand-purple/5">
