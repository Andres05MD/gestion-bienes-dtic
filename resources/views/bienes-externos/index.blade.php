                        ...
                        <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            ...
                            <div class="flex gap-2 min-w-0">
                                ...
                                <div class="flex gap-2 shrink-0">
                                    ...
                                    <a href="{{ route('bienes-externos.index') }}" class="p-4 bg-rose-500/10 text-rose-400 rounded-2xl hover:bg-rose-500/20 transition-colors shadow-lg shadow-rose-500/5 flex items-center" title="Limpiar Filtros">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
