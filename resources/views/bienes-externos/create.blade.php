<x-app-layout>
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="font-black text-3xl text-gray-800 dark:text-white leading-tight tracking-tight drop-shadow-md">
                    {{ __('Registrar Nuevo Bien Externo') }}
                </h2>
                <p class="text-sm font-medium text-gray-500 dark:text-dark-text uppercase tracking-widest mt-1">Inventario de Bienes Externos</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('bienes-externos.store') }}" class="space-y-8">
                @csrf
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="bg-white dark:bg-dark-850/40 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-white/5 relative z-10">
                            ...
                            <x-select-premium
                                ...
                                label="Departamento"
                                placeholder="Seleccione un depto/servicio"
                                required
