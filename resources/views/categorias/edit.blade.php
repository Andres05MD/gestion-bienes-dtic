<x-app-layout>
    ...
    <div class="py-12 relative overflow-hidden">
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('categorias.update', $categoria) }}" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white dark:bg-dark-850/40 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-white/5 relative group transition-all duration-500">
                    ...
                    <div class="flex items-center gap-3 mb-8">
                        <div class="w-10 h-10 bg-brand-purple/10 rounded-xl flex items-center justify-center">
                            <x-mary-icon name="o-bookmark" class="w-6 h-6 text-brand-lila" />
                        </div>
                        <h3 class="text-xl font-black text-gray-900 dark:text-white uppercase tracking-widest">Detalles de la Categoría</h3>
                    </div>
                    ...
                    <div class="space-y-6">
                        <x-input-premium
                            ...
                            autofocus
                            icon="o-tag"
                            placeholder="Ej: Mobiliario, Equipos Médicos"
                        />
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <textarea 
                                    ...
                                    placeholder="Breve descripción del tipo de bienes en esta categoría..."
