<x-app-layout>
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm font-medium text-gray-500 dark:text-dark-text uppercase tracking-widest mt-1">
                    Bien: <span class="text-brand-lila">#{{ $distribucion->numero_bien }}</span>
                </p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12 relative">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('distribuciones-direccion.update', $distribucion) }}" class="space-y-8">
                @csrf
                @method('PUT')
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="bg-white dark:bg-dark-850/40 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-white/5">
                            ...
                            <div x-data="{
                                ...
                                globalSearch: '',
                                bienSearch: '',
                                tipoBien: '{{ $distribucion->bien_id ? 'dtic' : ($distribucion->bien_externo_id ? 'externo' : '') }}',
                                ...
                                <input type="hidden" name="bien_id" id="bien_id" value="{{ old('bien_id', $distribucion->bien_id) }}">
                                <input type="hidden" name="bien_externo_id" id="bien_externo_id" value="{{ old('bien_externo_id', $distribucion->bien_externo_id) }}">
                            </div>
                        </div>
                        ...
                        <div class="bg-white dark:bg-dark-850/40 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-white/5">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <x-input-premium name="numero_bien" label="Número de Bien" :value="$distribucion->numero_bien" required icon="o-hashtag" id="numero_bien" />
                                <x-input-premium name="descripcion" label="Descripción" :value="$distribucion->descripcion" required icon="o-document-text" id="descripcion" />
                                <x-input-premium name="marca" label="Marca" :value="$distribucion->marca" icon="o-tag" id="marca" />
                                <x-input-premium name="serial" label="Serial" :value="$distribucion->serial" icon="o-qr-code" id="serial" />
                                <x-date-input-premium name="fecha" label="Fecha" :value="$distribucion->fecha->format('Y-m-d')" required />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-white dark:bg-dark-850/40 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-white/5 relative z-10">
                            ...
                            <div class="space-y-6">
                                <x-select-premium
                                    ...
                                    :value="old('estatus_acta_id', $distribucion->estatus_acta_id)" />
                            </div>
                        </div>
