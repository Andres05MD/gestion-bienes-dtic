                    ...
                    <form method="GET" action="{{ route('distribuciones-direccion.index') }}" class="mb-8 space-y-4">
                        <div class="flex flex-col xl:flex-row gap-4">
                            ...
                            <div class="flex gap-2">
                                ...
                                @if(request()->anyFilled(['buscar', 'procedencia_id', 'estatus_acta_id', 'fecha_desde', 'fecha_hasta']))
                                ...
                                <tr class="hover:bg-dark-800/30 transition-all duration-300">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <span class="px-2.5 py-1.5 inline-block text-center text-[10px] leading-4 font-black rounded-lg shadow-sm uppercase tracking-widest"
                                            ...
                                            {!! str_replace(' falta ', '<br>falta ', e($distribucion->estatusActa?->nombre ?? 'N/A')) !!}
                                        </span>
                                    </td>
                                    ...
                                    <td colspan="8" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <p class="text-gray-500 dark:text-gray-400 font-medium">
                                                @if(request()->anyFilled(['buscar', 'procedencia_id', 'estatus_acta_id']))
