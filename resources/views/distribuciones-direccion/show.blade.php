    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div class="flex items-center gap-4">
                <div class="relative w-14 h-14 group">
                    ...
                    <div class="relative w-full h-full bg-dark-850 border border-white/5 rounded-xl flex items-center justify-center shadow-2xl overflow-hidden">
                        ...
                        <x-mary-icon name="o-clipboard-document-list" class="w-7 h-7 text-brand-lila group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-500" />
                    </div>
                </div>
                <div>
            ...
            <div class="flex items-center gap-4 bg-dark-850/50 p-2 rounded-2xl border border-white/5 backdrop-blur-md">
                ...
                <a href="{{ route('distribuciones-direccion.edit', $distribucion) }}" class="inline-flex items-center px-6 py-3 bg-white dark:bg-white text-brand-purple rounded-xl font-black text-[10px] uppercase tracking-widest hover:brightness-90 active:scale-95 transition-all shadow-lg">
                    <x-mary-icon name="o-pencil-square" class="w-4 h-4 mr-2" />
                    {{ __('Editar Registro') }}
                </a>
                @endcan
                <a href="{{ route('distribuciones-direccion.index') }}" class="px-6 py-3 text-[10px] font-black text-gray-400 hover:text-white uppercase tracking-widest transition-all">
                    {{ __('Cerrar') }}
                </a>
            </div>
        </div>
                    ...
                    <div class="bg-dark-850 rounded-[2.5rem] border border-white/5 overflow-hidden shadow-2xl group">
                        <div class="px-8 py-10 relative z-10 text-center">
                            <div class="w-24 h-24 mx-auto bg-dark-900 rounded-3xl border-4 border-dark-850 flex items-center justify-center shadow-2xl group-hover:scale-105 transition-transform duration-500">
                                <x-mary-icon name="o-clipboard-document-list" class="w-12 h-12 text-brand-lila" />
                            </div>
