                            ...
                            <div class="bg-dark-850 p-8 rounded-3xl border border-white/5 shadow-xl">
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-lg font-bold text-white">{{ $desincorporacion->procedencia?->nombre ?? 'N/A' }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="px-6 py-6 rounded-3xl border border-dashed border-white/10 bg-white/2">
                                <div class="space-y-4">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="text-xs font-mono text-gray-300">{{ $desincorporacion->created_at->format('d/m/Y') }}</span>
                                    </div>
                                    <div class="h-px bg-white/5"></div>
                                    <div class="flex items-center justify-between">
                                        <span class="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Registrado por</span>
                                        <span class="text-xs font-bold text-brand-lila">{{ $desincorporacion->user?->name }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
