<x-app-layout>
    ...
    <div class="py-12 relative overflow-hidden">
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('areas.update', $area) }}" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white dark:bg-dark-850/40 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-white/5 relative group transition-all duration-500">
                    ...
                    <div class="flex items-center gap-3 mb-8">
                        ...
                        <h3 class="text-xl font-black text-gray-900 dark:text-white uppercase tracking-widest">Detalles del Área</h3>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <textarea 
                                    ...
                                    placeholder="Breve descripción de la ubicación o función del área..."
