...
- Registro detallado: Equipo, Marca, Modelo, Serial, Color, Número de Bien (Opcional, proforma "S/N"), Categoría (Opcional, proforma "PENDIENTE POR CATEGORÍA"), Estado (FK), Observaciones, Área/Ubicación (FK).
...
- Registro detallado: Equipo, Marca, Modelo, Serial, Color, Número de Bien (Opcional, proforma "S/N"), Categoría (Opcional, proforma "PENDIENTE POR CATEGORÍA"), Estado (FK), Observaciones, Departamento (FK).
...
- Tarjetas de resumen interactivas: Los KPIs y estados funcionan como accesos directos y filtros hacia el inventario.
