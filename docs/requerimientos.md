...
- [x] **Categoría junto al Número de Bien:** Visualización de la categoría al lado del número de bien en las tablas.
...
- [x] **Listado:** Tabla con N° Bien, Descripción, Serial, Procedencia, Destino, Fecha, Estatus, Fecha de Firma.
...
- [x] **Detección de Procedencia:** Al importar, se detecta automáticamente si es DTIC o Departamento externo.
...
- [x] **Número de Informe:** Formato estandarizado "00-00-00".
