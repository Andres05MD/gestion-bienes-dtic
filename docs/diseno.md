...
### Inputs (`<x-input-premium>` y `<x-select-premium>`)

Componente estandarizado para formularios y selectores.
...
- **Read-only**: Los campos de solo lectura (como al importar bienes o en devoluciones) reducen ligeramente la opacidad y cambian el cursor para indicar su estado inalterable manteniendo la concordancia visual premium.
